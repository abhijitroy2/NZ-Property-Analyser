# NZ Property Analyser - Rental Mode (PowerShell Script)

Write-Host "NZ Property Analyser - Rental Mode" -ForegroundColor Cyan
Write-Host ""
...
# Run the program
& $pythonPath main.py residential_sale.xlsx --mode rental --background
